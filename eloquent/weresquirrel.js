...
function addEntry(journal, events, squirrel) {
    journal.push({
        events,
        squirrel
    });
...
// Calculating corelation on event
function phi(table) {
...
// Creating corelation table for event
...
// Creating list of journal events
...
for (let entry of journal) {
    if (entry.events.includes('peanuts') && 
        !entry.events.includes('brushed teeth')) {
            entry.events.push('peenut teeth');
    }
}
console.log(phi(tableFor('peenut teeth', journal)));
