...
// let rtlScripts = SCRIPTS.filter(s => s.living);
...
// biggest script witout high-order functions
let biggest = null;
...
// console.log(textScripts('Бля как же всё заебало! wtf guys rly?! 🌹🐉'));
...
// console.log(dominantDirection('Бля как же всё заебало! wtf guys rly?! 🌹🐉'));
// test
